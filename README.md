...
> 🔴 **LIVE INVESTIGATION FEED** &middot; Auto-updated &middot; Last fetch `2026-08-01`

<table><tr>
<td align="center"><b>📦 Domains tracked</b><br/><sub><code>5,281,108</code></sub></td>
<td align="center"><b>💰 Est. revenue</b><br/><sub><code>$37,624,563</code></sub></td>
<td align="center"><b>📡 Deployed</b><br/><sub><code>59.4%</code></sub></td>
<td align="center"><b>✅ Confirmed phishing</b><br/><sub><code>0.1%</code> (4,405)</sub></td>
...
|:--|--:|--:|--:|
| `.com` | 2,306,400 | 1,898d | $20,734,536 |
| `.sbs` | 375,300 | 627d | $1,872,747 |
| `.xyz` | 367,519 | 780d | $547,603 |
| `.net` | 256,342 | 1,567d | $2,560,857 |
| `.info` | 238,264 | 675d | $950,673 |
| `.org` | 230,998 | 1,530d | $2,307,670 |
| `.cfd` | 229,604 | 665d | $1,145,724 |
| `.click` | 93,886 | 519d | $374,605 |
| `.link` | 68,422 | 665d | $273,004 |
| `.vip` | 67,278 | 614d | $335,717 |
...
| `2025-12-01` | 14,260 | **30.6×** 🚨 |
| `2026-06-30` | 13,455 | **28.9×** 🚨 |
| `2026-07-01` | 12,766 | **27.4×** 🚨 |
| `2026-06-09` | 12,391 | **26.6×** 🚨 |

### 🎯 Top Targeted Brands & Keywords

`login (11,623)` &middot; `support (6,483)` &middot; `crypto (6,079)` &middot; `secure (6,036)` &middot; `connect (5,818)` &middot; `trust (5,815)` &middot; `account (4,070)` &middot; `official (4,011)` &middot; `farm (3,464)` &middot; `claim (3,243)` &middot; `bridge (3,212)` &middot; `update (3,143)` &middot; `vault (2,394)` &middot; `wallet (2,127)` &middot; `token (1,990)`
...
| 3 | `ser***@atom.com` | **4,993** |
| 4 | `inf***@brandbucket.com` | **2,424** |
| 5 | `sal***@brandbucket.com` | **2,424** |
