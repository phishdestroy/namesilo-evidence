...
> 🔴 **LIVE INVESTIGATION FEED** &middot; Auto-updated &middot; Last fetch `2026-08-20`

<table><tr>
<td align="center"><b>📦 Domains tracked</b><br/><sub><code>5,288,366</code></sub></td>
<td align="center"><b>💰 Est. revenue</b><br/><sub><code>$37,899,488</code></sub></td>
...
<td align="center"><b>🕵️ Serial regs</b><br/><sub><code>1,316</code></sub></td>
</tr></table>
...
|:--|--:|--:|--:|
| `.com` | 2,325,998 | 1,886d | $20,910,722 |
| `.sbs` | 367,968 | 630d | $1,836,160 |
| `.xyz` | 363,886 | 784d | $542,190 |
| `.net` | 260,250 | 1,554d | $2,599,898 |
| `.info` | 240,712 | 674d | $960,441 |
| `.org` | 233,739 | 1,524d | $2,335,053 |
| `.cfd` | 229,780 | 666d | $1,146,602 |
| `.click` | 91,748 | 520d | $366,075 |
| `.vip` | 68,330 | 632d | $340,967 |
| `.link` | 64,959 | 677d | $259,186 |
...
| `2025-12-01` | 14,295 | **30.7×** 🚨 |
| `2026-06-30` | 13,478 | **29.0×** 🚨 |
| `2026-07-01` | 12,775 | **27.5×** 🚨 |
| `2026-06-09` | 12,394 | **26.6×** 🚨 |

### 🎯 Top Targeted Brands & Keywords

`login (11,604)` &middot; `support (6,397)` &middot; `crypto (6,008)` &middot; `secure (5,883)` &middot; `trust (5,744)` &middot; `connect (5,734)` &middot; `official (4,326)` &middot; `account (4,033)` &middot; `farm (3,485)` &middot; `bridge (3,238)` &middot; `claim (3,174)` &middot; `update (3,129)` &middot; `vault (2,427)` &middot; `wallet (2,124)` &middot; `token (1,980)`

### 🕵️ Top Serial Registrants — 50 emails with ≥5 domains

| # | Registrant Email (redacted) | Domains |
|--:|:--|--:|
| 1 | `chi***@mail.com` | **10,493** |
| 2 | `diz***@992fun.com` | **8,923** |
| 3 | `ser***@atom.com` | **5,308** |
| 4 | `inf***@brandbucket.com` | **3,411** |
| 5 | `sal***@brandbucket.com` | **3,411** |
| 6 | `992***@gmail.com` | **1,699** |
| 7 | `diz***@91jqx.com` | **1,698** |
| 8 | `shu***@outlook.com` | **1,421** |
| 9 | `jac***@greensock.com` | **885** |
| 10 | `app***@bagelcode.com` | **635** |
